      ...
      0000BE 75 A1 55         [24]  598 	mov	_SAFE_MOD,#0x55
                                    599 ;	../../include/debug.c:35: SAFE_MOD = 0xAA;
      0000C1 75 A1 AA         [24]  600 	mov	_SAFE_MOD,#0xaa
                                    601 ;	../../include/debug.c:42: CLOCK_CFG = CLOCK_CFG & ~ MASK_SYS_CK_SEL | 0x05;  // 16MHz	
      0000C4 74 F8            [12]  602 	mov	a,#0xf8
      0000C6 55 B9            [12]  603 	anl	a,_CLOCK_CFG
      0000C8 44 05            [12]  604 	orl	a,#0x05
      0000CA F5 B9            [12]  605 	mov	_CLOCK_CFG,a
                                    606 ;	../../include/debug.c:57: SAFE_MOD = 0x00;
      0000CC 75 A1 00         [24]  607 	mov	_SAFE_MOD,#0x00
                                    608 ;	../../include/debug.c:58: }
      0000CF 22               [24]  609 	ret
                                    610 ;------------------------------------------------------------
                                    ...
                                    618 ;	-----------------------------------------
      0000D0                        619 _mDelayuS:
      0000D0 AE 82            [24]  620 	mov	r6,dpl
      0000D2 AF 83            [24]  621 	mov	r7,dph
                                    622 ;	../../include/debug.c:82: while ( n ) {  // total = 12~13 Fsys cycles, 1uS @Fsys=12MHz
      0000D4                        623 00101$:
      0000D4 EE               [12]  624 	mov	a,r6
      0000D5 4F               [12]  625 	orl	a,r7
      0000D6 60 0D            [24]  626 	jz	00104$
                                    627 ;	../../include/debug.c:83: ++ SAFE_MOD;  // 2 Fsys cycles, for higher Fsys, add operation here
      0000D8 05 A1            [12]  628 	inc	_SAFE_MOD
                                    629 ;	../../include/debug.c:86: ++ SAFE_MOD;
      0000DA 05 A1            [12]  630 	inc	_SAFE_MOD
                                    631 ;	../../include/debug.c:89: ++ SAFE_MOD;
      0000DC 05 A1            [12]  632 	inc	_SAFE_MOD
                                    633 ;	../../include/debug.c:116: -- n;
      0000DE 1E               [12]  634 	dec	r6
      0000DF BE FF 01         [24]  635 	cjne	r6,#0xff,00116$
      0000E2 1F               [12]  636 	dec	r7
      0000E3                        637 00116$:
      0000E3 80 EF            [24]  638 	sjmp	00101$
      0000E5                        639 00104$:
                                    640 ;	../../include/debug.c:118: }
      0000E5 22               [24]  641 	ret
                                    642 ;------------------------------------------------------------
                                    ...
                                    650 ;	-----------------------------------------
      0000E6                        651 _mDelaymS:
      0000E6 AE 82            [24]  652 	mov	r6,dpl
      0000E8 AF 83            [24]  653 	mov	r7,dph
                                    654 ;	../../include/debug.c:129: while ( n ) {
      0000EA                        655 00101$:
      0000EA EE               [12]  656 	mov	a,r6
      0000EB 4F               [12]  657 	orl	a,r7
      0000EC 60 15            [24]  658 	jz	00104$
                                    659 ;	../../include/debug.c:134: mDelayuS( 1000 );
      0000EE 90 03 E8         [24]  660 	mov	dptr,#0x03e8
      0000F1 C0 07            [24]  661 	push	ar7
      0000F3 C0 06            [24]  662 	push	ar6
      0000F5 12 00 D0         [24]  663 	lcall	_mDelayuS
      0000F8 D0 06            [24]  664 	pop	ar6
      0000FA D0 07            [24]  665 	pop	ar7
                                    666 ;	../../include/debug.c:136: -- n;
      0000FC 1E               [12]  667 	dec	r6
      0000FD BE FF 01         [24]  668 	cjne	r6,#0xff,00116$
      000100 1F               [12]  669 	dec	r7
      000101                        670 00116$:
      000101 80 E7            [24]  671 	sjmp	00101$
      000103                        672 00104$:
                                    673 ;	../../include/debug.c:138: }                                         
      000103 22               [24]  674 	ret
                                    675 ;------------------------------------------------------------
                                    ...
                                    681 ;	-----------------------------------------
      000104                        682 _CH554UART0Alter:
                                    683 ;	../../include/debug.c:149: PIN_FUNC |= bUART0_PIN_X;                                                  //串口映射到P1.2和P1.3
      000104 43 C6 10         [24]  684 	orl	_PIN_FUNC,#0x10
                                    685 ;	../../include/debug.c:150: }
      000107 22               [24]  686 	ret
                                    687 ;------------------------------------------------------------
                                    ...
                                    696 ;	-----------------------------------------
      000108                        697 _mInitSTDIO:
                                    698 ;	../../include/debug.c:166: SM0 = 0;
                                    699 ;	assignBit
      000108 C2 9F            [12]  700 	clr	_SM0
                                    701 ;	../../include/debug.c:167: SM1 = 1;
                                    702 ;	assignBit
      00010A D2 9E            [12]  703 	setb	_SM1
                                    704 ;	../../include/debug.c:168: SM2 = 0;                                                                   //串口0使用模式1
                                    705 ;	assignBit
      00010C C2 9D            [12]  706 	clr	_SM2
                                    707 ;	../../include/debug.c:170: RCLK = 0;                                                                  //UART0接收时钟
                                    708 ;	assignBit
      00010E C2 CD            [12]  709 	clr	_RCLK
                                    710 ;	../../include/debug.c:171: TCLK = 0;                                                                  //UART0发送时钟
                                    711 ;	assignBit
      000110 C2 CC            [12]  712 	clr	_TCLK
                                    713 ;	../../include/debug.c:172: PCON |= SMOD;
      000112 43 87 80         [24]  714 	orl	_PCON,#0x80
                                    715 ;	../../include/debug.c:173: x = 10 * FREQ_SYS / UART0_BAUD / 16;                                       //如果更改主频，注意x的值不要溢出
      000115 75 08 11         [24]  716 	mov	_mInitSTDIO_x_65536_17,#0x11
      000118 75 09 04         [24]  717 	mov	(_mInitSTDIO_x_65536_17 + 1),#0x04
      00011B E4               [12]  718 	clr	a
      00011C F5 0A            [12]  719 	mov	(_mInitSTDIO_x_65536_17 + 2),a
      00011E F5 0B            [12]  720 	mov	(_mInitSTDIO_x_65536_17 + 3),a
                                    721 ;	../../include/debug.c:174: x2 = x % 10;
      000120 75 45 0A         [24]  722 	mov	__modulong_PARM_2,#0x0a
      000123 F5 46            [12]  723 	mov	(__modulong_PARM_2 + 1),a
      000125 F5 47            [12]  724 	mov	(__modulong_PARM_2 + 2),a
      000127 F5 48            [12]  725 	mov	(__modulong_PARM_2 + 3),a
      000129 85 08 82         [24]  726 	mov	dpl,_mInitSTDIO_x_65536_17
      00012C 85 09 83         [24]  727 	mov	dph,(_mInitSTDIO_x_65536_17 + 1)
      00012F 85 0A F0         [24]  728 	mov	b,(_mInitSTDIO_x_65536_17 + 2)
      000132 E5 0B            [12]  729 	mov	a,(_mInitSTDIO_x_65536_17 + 3)
      000134 12 02 C2         [24]  730 	lcall	__modulong
      000137 AC 82            [24]  731 	mov	r4,dpl
      000139 8C 0C            [24]  732 	mov	_mInitSTDIO_x2_65536_17,r4
                                    733 ;	../../include/debug.c:175: x /= 10;
      00013B 75 45 0A         [24]  734 	mov	__divulong_PARM_2,#0x0a
      00013E E4               [12]  735 	clr	a
      00013F F5 46            [12]  736 	mov	(__divulong_PARM_2 + 1),a
      000141 F5 47            [12]  737 	mov	(__divulong_PARM_2 + 2),a
      000143 F5 48            [12]  738 	mov	(__divulong_PARM_2 + 3),a
      000145 85 08 82         [24]  739 	mov	dpl,_mInitSTDIO_x_65536_17
      000148 85 09 83         [24]  740 	mov	dph,(_mInitSTDIO_x_65536_17 + 1)
      00014B 85 0A F0         [24]  741 	mov	b,(_mInitSTDIO_x_65536_17 + 2)
      00014E E5 0B            [12]  742 	mov	a,(_mInitSTDIO_x_65536_17 + 3)
      000150 12 03 45         [24]  743 	lcall	__divulong
      000153 85 82 08         [24]  744 	mov	_mInitSTDIO_x_65536_17,dpl
      000156 85 83 09         [24]  745 	mov	(_mInitSTDIO_x_65536_17 + 1),dph
      000159 85 F0 0A         [24]  746 	mov	(_mInitSTDIO_x_65536_17 + 2),b
      00015C F5 0B            [12]  747 	mov	(_mInitSTDIO_x_65536_17 + 3),a
                                    748 ;	../../include/debug.c:176: if ( x2 >= 5 ) x ++;                                                       //四舍五入
      00015E 74 FB            [12]  749 	mov	a,#0x100 - 0x05
      000160 25 0C            [12]  750 	add	a,_mInitSTDIO_x2_65536_17
      000162 50 19            [24]  751 	jnc	00102$
      000164 AC 08            [24]  752 	mov	r4,_mInitSTDIO_x_65536_17
      000166 AD 09            [24]  753 	mov	r5,(_mInitSTDIO_x_65536_17 + 1)
      000168 AE 0A            [24]  754 	mov	r6,(_mInitSTDIO_x_65536_17 + 2)
      00016A AF 0B            [24]  755 	mov	r7,(_mInitSTDIO_x_65536_17 + 3)
      00016C 74 01            [12]  756 	mov	a,#0x01
      00016E 2C               [12]  757 	add	a,r4
      00016F F5 08            [12]  758 	mov	_mInitSTDIO_x_65536_17,a
      000171 E4               [12]  759 	clr	a
      000172 3D               [12]  760 	addc	a,r5
      000173 F5 09            [12]  761 	mov	(_mInitSTDIO_x_65536_17 + 1),a
      000175 E4               [12]  762 	clr	a
      000176 3E               [12]  763 	addc	a,r6
      000177 F5 0A            [12]  764 	mov	(_mInitSTDIO_x_65536_17 + 2),a
      000179 E4               [12]  765 	clr	a
      00017A 3F               [12]  766 	addc	a,r7
      00017B F5 0B            [12]  767 	mov	(_mInitSTDIO_x_65536_17 + 3),a
      00017D                        768 00102$:
                                    769 ;	../../include/debug.c:178: TMOD = TMOD & ~ bT1_GATE & ~ bT1_CT & ~ MASK_T1_MOD | bT1_M1;              //0X20，Timer1作为8位自动重载定时器
      00017D 74 0F            [12]  770 	mov	a,#0x0f
      00017F 55 89            [12]  771 	anl	a,_TMOD
      000181 44 20            [12]  772 	orl	a,#0x20
      000183 F5 89            [12]  773 	mov	_TMOD,a
                                    774 ;	../../include/debug.c:179: T2MOD = T2MOD | bTMR_CLK | bT1_CLK;                                        //Timer1时钟选择
      000185 43 C9 A0         [24]  775 	orl	_T2MOD,#0xa0
                                    776 ;	../../include/debug.c:180: TH1 = 0-x;                                                                 //12MHz晶振,buad/12为实际需设置波特率
      000188 AF 08            [24]  777 	mov	r7,_mInitSTDIO_x_65536_17
      00018A C3               [12]  778 	clr	c
      00018B E4               [12]  779 	clr	a
      00018C 9F               [12]  780 	subb	a,r7
      00018D F5 8D            [12]  781 	mov	_TH1,a
                                    782 ;	../../include/debug.c:181: TR1 = 1;                                                                   //启动定时器1
                                    783 ;	assignBit
      00018F D2 8E            [12]  784 	setb	_TR1
                                    785 ;	../../include/debug.c:182: TI = 1;
                                    786 ;	assignBit
      000191 D2 99            [12]  787 	setb	_TI
                                    788 ;	../../include/debug.c:183: REN = 1;                                                                   //串口0接收使能
                                    789 ;	assignBit
      000193 D2 9C            [12]  790 	setb	_REN
                                    791 ;	../../include/debug.c:184: }
      000195 22               [24]  792 	ret
                                    793 ;------------------------------------------------------------
                                    ...
                                    799 ;	-----------------------------------------
      000196                        800 _CH554UART0RcvByte:
                                    801 ;	../../include/debug.c:195: while(RI == 0);                                                            //查询接收，中断方式可不用
      000196                        802 00101$:
                                    803 ;	../../include/debug.c:196: RI = 0;
                                    804 ;	assignBit
      000196 10 98 02         [24]  805 	jbc	_RI,00114$
      000199 80 FB            [24]  806 	sjmp	00101$
      00019B                        807 00114$:
                                    808 ;	../../include/debug.c:197: return SBUF;
      00019B 85 99 82         [24]  809 	mov	dpl,_SBUF
                                    810 ;	../../include/debug.c:198: }
      00019E 22               [24]  811 	ret
                                    812 ;------------------------------------------------------------
                                    ...
                                    820 ;	-----------------------------------------
      00019F                        821 _CH554UART0SendByte:
      00019F 85 82 99         [24]  822 	mov	_SBUF,dpl
                                    823 ;	../../include/debug.c:210: while(TI ==0);
      0001A2                        824 00101$:
                                    825 ;	../../include/debug.c:211: TI = 0;
                                    826 ;	assignBit
      0001A2 10 99 02         [24]  827 	jbc	_TI,00114$
      0001A5 80 FB            [24]  828 	sjmp	00101$
      0001A7                        829 00114$:
                                    830 ;	../../include/debug.c:212: }
      0001A7 22               [24]  831 	ret
                                    832 ;------------------------------------------------------------
                                    ...
                                    840 ;	-----------------------------------------
      0001A8                        841 _putchar:
      0001A8 AE 82            [24]  842 	mov	r6,dpl
      0001AA AF 83            [24]  843 	mov	r7,dph
                                    844 ;	../../include/debug.c:231: while (!TI) /* assumes UART is initialized */
      0001AC                        845 00101$:
                                    846 ;	../../include/debug.c:233: TI = 0;
                                    847 ;	assignBit
      0001AC 10 99 02         [24]  848 	jbc	_TI,00114$
      0001AF 80 FB            [24]  849 	sjmp	00101$
      0001B1                        850 00114$:
                                    851 ;	../../include/debug.c:234: SBUF = c & 0xFF;
      0001B1 8E 99            [24]  852 	mov	_SBUF,r6
                                    853 ;	../../include/debug.c:236: return c;
      0001B3 8E 82            [24]  854 	mov	dpl,r6
      0001B5 8F 83            [24]  855 	mov	dph,r7
                                    856 ;	../../include/debug.c:237: }
      0001B7 22               [24]  857 	ret
                                    858 ;------------------------------------------------------------
      ...
      0001B8                        867 00101$:
                                    ...
                                    869 ;	assignBit
      0001B8 10 98 02         [24]  870 	jbc	_RI,00114$
      0001BB 80 FB            [24]  871 	sjmp	00101$
      0001BD                        872 00114$:
                                    873 ;	../../include/debug.c:242: return SBUF;
      0001BD AE 99            [24]  874 	mov	r6,_SBUF
      0001BF 7F 00            [12]  875 	mov	r7,#0x00
      0001C1 8E 82            [24]  876 	mov	dpl,r6
      0001C3 8F 83            [24]  877 	mov	dph,r7
                                    878 ;	../../include/debug.c:243: }
      0001C5 22               [24]  879 	ret
                                    880 ;------------------------------------------------------------
                                    ...
                                    886 ;	-----------------------------------------
      0001C6                        887 _CH554UART1Alter:
                                    888 ;	../../include/debug.c:255: PIN_FUNC |= bUART1_PIN_X;
      0001C6 43 C6 20         [24]  889 	orl	_PIN_FUNC,#0x20
                                    890 ;	../../include/debug.c:256: }
      0001C9 22               [24]  891 	ret
                                    892 ;------------------------------------------------------------
      ...
      0001D3 22               [24]  912 	ret
                                    ...
                                    919 ;	-----------------------------------------
      0001D4                        920 _CH554UART1RcvByte:
                                    921 ;	../../include/debug.c:282: while(U1RI == 0);                                                           //查询接收，中断方式可不用
      0001D4                        922 00101$:
                                    923 ;	../../include/debug.c:283: U1RI = 0;
                                    924 ;	assignBit
      0001D4 10 C0 02         [24]  925 	jbc	_U1RI,00114$
      0001D7 80 FB            [24]  926 	sjmp	00101$
      0001D9                        927 00114$:
                                    928 ;	../../include/debug.c:284: return SBUF1;
      0001D9 85 C1 82         [24]  929 	mov	dpl,_SBUF1
                                    930 ;	../../include/debug.c:285: }
      0001DC 22               [24]  931 	ret
                                    932 ;------------------------------------------------------------
                                    ...
                                    940 ;	-----------------------------------------
      0001DD                        941 _CH554UART1SendByte:
      0001DD 85 82 C1         [24]  942 	mov	_SBUF1,dpl
                                    943 ;	../../include/debug.c:297: while(U1TI ==0);
      0001E0                        944 00101$:
                                    945 ;	../../include/debug.c:298: U1TI = 0;
                                    946 ;	assignBit
      0001E0 10 C1 02         [24]  947 	jbc	_U1TI,00114$
      0001E3 80 FB            [24]  948 	sjmp	00101$
      0001E5                        949 00114$:
                                    950 ;	../../include/debug.c:299: }
      0001E5 22               [24]  951 	ret
                                    952 ;------------------------------------------------------------
                                    ...
                                    960 ;	-----------------------------------------
      0001E6                        961 _CH554WDTModeSelect:
      0001E6 AF 82            [24]  962 	mov	r7,dpl
                                    963 ;	../../include/debug.c:312: SAFE_MOD = 0x55;
      0001E8 75 A1 55         [24]  964 	mov	_SAFE_MOD,#0x55
                                    965 ;	../../include/debug.c:313: SAFE_MOD = 0xaa;                                                             //进入安全模式
      0001EB 75 A1 AA         [24]  966 	mov	_SAFE_MOD,#0xaa
                                    967 ;	../../include/debug.c:314: if(mode){
      0001EE EF               [12]  968 	mov	a,r7
      0001EF 60 05            [24]  969 	jz	00102$
                                    970 ;	../../include/debug.c:315: GLOBAL_CFG |= bWDOG_EN;                                                    //启动看门狗复位
      0001F1 43 B1 01         [24]  971 	orl	_GLOBAL_CFG,#0x01
      0001F4 80 03            [24]  972 	sjmp	00103$
      0001F6                        973 00102$:
                                    974 ;	../../include/debug.c:317: else GLOBAL_CFG &= ~bWDOG_EN;	                                            //启动看门狗仅仅作为定时器
      0001F6 53 B1 FE         [24]  975 	anl	_GLOBAL_CFG,#0xfe
      0001F9                        976 00103$:
                                    977 ;	../../include/debug.c:318: SAFE_MOD = 0x00;                                                             //退出安全模式
      0001F9 75 A1 00         [24]  978 	mov	_SAFE_MOD,#0x00
                                    979 ;	../../include/debug.c:319: WDOG_COUNT = 0;                                                              //看门狗赋初值
      0001FC 75 FF 00         [24]  980 	mov	_WDOG_COUNT,#0x00
                                    981 ;	../../include/debug.c:320: }
      0001FF 22               [24]  982 	ret
                                    983 ;------------------------------------------------------------
                                    ...
                                    991 ;	-----------------------------------------
      000200                        992 _CH554WDTFeed:
      000200 85 82 FF         [24]  993 	mov	_WDOG_COUNT,dpl
                                    994 ;	../../include/debug.c:333: WDOG_COUNT = tim;                                                             //看门狗计数器赋值
                                    995 ;	../../include/debug.c:334: }
      000203 22               [24]  996 	ret
                                    997 	.area CSEG    (CODE)
                                    998 	.area CONST   (CODE)
                                    999 	.area XINIT   (CODE)
