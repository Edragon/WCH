...
"******                K1松开时：多媒体键盘功能                ******\r\n",
"******    K2:音量降低  K3:音量提升  K4:静音开关 K5:播放/暂停  ******\r\n",
"******            K6:一键上网  K7:系统待机  K8:系统关机       ******\r\n",
"********************************************************************\r\n",
};
...
void SendReport(void)
{
 ...
 //我们用KEY1键来选择剩余的7个键是普通键盘功能还是多媒体键功能。
 //当KEY1按住时，剩余7个键为普通键盘功能，这7个键的功能跟键盘
 //实例的一样。当KEY1松开时，剩余7个键为多媒体键盘，功能分别为：
 //KEY2：音量降低，KEY3：音量提升，KEY4：静音开关，KEY5：停止/播放，
 //KEY6：打开网页，KEY7：系统待机，KEY8：系统关机。
 ...
 else  //KEY1松开，用户控制设备
 {
  ...
  {
   Buf[1]|=0x01;  //KEY2为音量降低。
  }
  if(KeyPress & KEY3) //如果KEY3按下
  {
   Buf[1]|=0x02;  //KEY3为音量提升。
  }
  if(KeyPress & KEY4) //如果KEY4按下
  {
   Buf[1]|=0x04;  //KEY4为静音开关。
  }
  ...
  if(KeyPress & KEY6)  //如果KEY6按住
  {
   Buf[1]|=0x10;  //KEY6为打开网页。
  }
  if(KeyPress & KEY7)  //如果KEY7按住
  {
   Buf[1]|=0x20;  //KEY7为系统待机。
  }
  if(KeyPress & KEY8)  //如果KEY8按住
  {
   Buf[1]|=0x40;  //KEY8为系统关机。
  }
