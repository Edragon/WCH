...
__irq void FIQ_Handler( void )
{
    ...
    if( R8_INT_FLAG_0 & RB_IF_TMR0 ){                                           /* 定时器中断 */
        ...
        if( R8_TMR0_INT_FLAG & RB_TMR_IF_DMA_END ){
            R8_INT_EN_FIQ_0 &= ~RB_IE_FIQ_TMR0;                                 /* 关闭定时器中断 */      
            ...
            R8_INT_EN_FIQ_0 |= RB_IE_FIQ_TMR0;                                  /* 开启定时器中断 */
        }
    } 
}
...
void TIM0_INIT( void ) 
{
    ...
    R8_INT_EN_FIQ_0 |= RB_IE_FIQ_TMR0;                                          /* 开启定时器 */
    /*以下为DMA配置*/     
    ...
    R8_INT_EN_FIQ_GLOB |= RB_IE_FIQ_GLOB;                                       /* 开启全局中断 */
    R8_TMR0_INT_FLAG = 0x7f;                                                    /* 清中断 */
} 
