...
const char *Btest = "ch563 FTP server demo";
...
/*******************************************************************************
* Function Name  : CH563NET_FTPListRenew
* Description    : 更新目录
* Input          : index -要更新的状态（0-则为添加了新文件，其他只需更新文件大小信息）
* Output         : None
* Return         : None
*******************************************************************************/
void CH563NET_FTPListRenew( UINT8 index )
{
     UINT8 i,k;
...
/*******************************************************************************
* Function Name  : CH563NET_FTPFileSize
* Description    : 获取文件长度
* Input          : pName -文件名
* Output         : None
* Return         : None
*******************************************************************************/
UINT32 CH563NET_FTPFileSize( char *pName )
{
    UINT8 i;
...
/*******************************************************************************
* Function Name  : CH563NET_FTPFileOpen
* Description    : 打开文件
* Input          : pName -文件名
                   index -判断打开的为文件夹还是文件
* Output         : None
* Return         : None
*******************************************************************************/
UINT8 CH563NET_FTPFileOpen( char *pName,UINT8 index )
{
    UINT8 k;
    char  *pList;
...
/*******************************************************************************
* Function Name  : CH563NET_FTPFileRead
* Description    : 读文件
* Input          : pName -文件名
* Output         : None
* Return         : None
*******************************************************************************/
void CH563NET_FTPFileRead( char *pName )
{
    UINT32 len;
    ...
    memset((void *)SendBuf,'\0',sizeof(SendBuf));
      if(pName[0] == '0' ){                                                     /* 打开列表信息 */
        ...
        len = CH563NET_FTPFileSize( pName );                                    /* 获取要读取文件长度 */
        if(len < SendBufLen){
            memset(SendBuf,'\0',sizeof(SendBuf));
...
/*******************************************************************************
* Function Name  : CH563NET_FTPFileWrite
...
* Return         : None
*******************************************************************************/
void CH563NET_FTPFileWrite( char *recv_buff, UINT16 len ) 
{
    UINT8 i,k;
