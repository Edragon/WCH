...
*                      (1)、CH563 TCP/IP 协议族接口;
*                      (2)、串口0输出监控信息,115200bps;
*                      (3)、CH563NET库演示文件，本程序用于演示DNS域名解析功能,ARM966,Thumb,小端
*******************************************************************************/
...
/* CH563相关定义 */
UINT8 MACAddr[6] = {0x0e,0x0d,0x04,0x05,0x06,0x27};                             /* CH563MAC地址 */
UINT8 IPAddr[4] =  {192,168,1,10};                                              /* CH563IP地址 */
