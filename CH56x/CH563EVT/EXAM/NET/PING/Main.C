...
#define CH563IP_DBG                           1                                 /* printf调试使能 */
/* CH563相关定义 */                                                                   
...
void CH563NET_HandleSockInt(UINT8 sockeid,UINT8 initstat)
{
    ...
    if(initstat & SINT_STAT_RECV)                                               /* 接收中断 */
    {
        ...
        CH563NET_IcmpRecvData( len,MyBuf );
    }
...
/*******************************************************************************
* Function Name  : CH563NET_CreatTIPRAWSocket
* Description    : 创建IPRAW socket
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
void CH563NET_CreatTIPRAWSocket(void)
{
   UINT8 i;
...
/*******************************************************************************
* Function Name  : CH563NET_PINGSendData
* Description    : 发送数据
* Input          : None
* Output         : None
* Return         : None
...
void CH563NET_PINGInit( void ) 
{
    ...
    InitSysHal();                                                               /* 初始化中断 */
    CH563NET_CreatTIPRAWSocket();                                               /* 创建IPRAW */
    InitParameter( );
    InitPing( );
}
